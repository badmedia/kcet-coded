  ...
  return (
    <div className="space-y-6">
      ...
      <div className="fixed bottom-4 right-4 z-50">
        <div className="bg-black/60 backdrop-blur-sm rounded-full px-4 py-2 text-sm text-white flex items-center gap-2 shadow-lg border border-white/20">
          <span className="text-red-400">❤️</span>
          <span className="font-medium">by u/Elegant_Compote9073</span>
          <span className="text-xs opacity-60">{new Date().getTime()}</span>
        </div>
      </div>
